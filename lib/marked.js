...
InlineLexer.prototype.output = function(src) {
  ...
  while (src) {
    ...
    if (cap = this.rules.autolink.exec(src)) {
      ...
      out += this.outputLink(['', text], {href:href}, true);
      continue;
    }
...
InlineLexer.prototype.outputLink = function(cap, link, is_autolink) {
  em_options_cap = (cap.hasOwnProperty(3)) ? cap[cap.length - 1] : undefined;
  if (!this.options.embedding || (cap.hasOwnProperty(0) && cap[0].charAt(0) !== '!') ) {
