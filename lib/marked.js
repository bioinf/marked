...
InlineLexer.prototype.outputLink = function(cap, link) {
  ...
  if (cap[0].charAt(0) !== '!' || !this.options.embedding) {
    
    this.gen_link = function (href, no_blank) {      
      return '<a '
    ...
    this.gen_stepic_link = function (href, no_blank) {
    ...
    if(stl_cap = inline._stepic_link.course.exec(link.href)) {
      ...
      return this.gen_stepic_link('/lesson/' + stl_cap[1] + '/#/step/' + stl_cap[2]);
      ...
      return this.gen_stepic_link('#/step/' + stl_cap[1], true);
    } else {
